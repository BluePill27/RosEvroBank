# -*- coding: utf-8 -*-
'''
  4 Программа получает список xml файлов содержащихся из каталога указанного в параметрах  
  5 В каждом XML файле добавляется дополнительный счет <Account> и заменяется узел <ServPackName>  
  6 Подробнее смотри в К:  
  7
'''
import sys
import os
...
if __name__ == "__main__":
     ...
     for file in fileList: # now edit only first 10 files
         if ".xml" in file:
